...
public class CategoryUCI implements CategoryIB {
    ...
    public CategoryOD addCategoryInMonth(CategoryID categoryIDAdd) {
        try {
            ...
            Category newCategory = (Category) categoryFactory.createMonthObject(setCategoryCreatorFactoryInputData(categoryIDAdd));
    ...
    public CategoryOD editCategoryInMonth(CategoryID categoryIDEdit) throws EntityException {
        ...
        try {
            ...
            categoryFactory.editMonthObject(setCategoryEditorFactoryInputData(categoryIDEdit));
     ...
     */
    private MonthObjectFactoryInputData setCategoryCreatorFactoryInputData(CategoryID categoryIDAdd) {
     ...
     */
    private MonthObjectFactoryInputData setCategoryEditorFactoryInputData(CategoryID categoryIDEdit) {
